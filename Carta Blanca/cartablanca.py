...
class CartaBlanca(object):
	...
	def show_game(self):
		...
		print()
		if len(self.org[0]) > 0:
			print('(0)', self.org[1][-1], end="      ")
		else: 
			print('Pozo (0)', end="      ")

		if len(self.org[1]) > 0:
			print('(1)', self.org[1][-1], end="      ")
		else: 
			print('Pozo (1)', end="      ")

		if len(self.org[2]) > 0:
			print('(2)', self.org[1][-1], end="      ")
		else: 
			print('Pozo (2)', end="      ")

		if len(self.org[3]) > 0:
			print('(3)', self.org[1][-1], end="         ")
		else: 
			print('Pozo (3)', end="                    ")


		if len(self.org[4]) > 0:	
			print('(4)', self.org[2][-1], end="      ")
		else:
			print('Corazones (4)', end="      ")
		
		if len(self.org[5]) > 0:
			print("(5)", self.org[3][-1],end="      ")
		else:
			print("Diamantes (5)", end="      ")
		
		if len(self.org[6]) > 0:
			print('(6)', self.org[4][-1], end="      ")
		else:
			print("Tréboles (6)", end="      ")
		
		if len(self.org[7]) > 0:
			print('(7)', self.org[5][-1], end="      ")
		else:
			print("Picas (7)", end="      ")
